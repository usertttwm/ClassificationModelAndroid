...
public class DetectorActivity extends CameraActivity implements OnImageAvailableListener {
    ...
    private static final String TF_OD_API_MODEL_FILE = "dinneryolobest.tflite";



    private static final String TF_OD_API_LABELS_FILE = "customclasses.txt";
    private static final int TF_OD_API_INPUT_SIZEE = 200;

    private static final String TF_OD_API_MODEL_FILEE = "fcsoupMaincourseSaladDessert.tflite";
    ...
    private Bitmap croppedBitmapp = null;
        ...
        runInBackground(
                new Runnable() {
                    ...
                    public void run() {
                        ...
                        //CROP SECTION_____________________
                        croppedBitmapp = Bitmap.createScaledBitmap(croppedBitmap, TF_OD_API_INPUT_SIZEE, TF_OD_API_INPUT_SIZEE, true);
                        final String resultLabel = detector1.recognizeImage1(croppedBitmapp);

                        Float confidence = -1f;



//                        Bitmap croppedBitmapp = Bitmap.createBitmap(croppedBitmap,
//                                100, 100,100, 100); I didn't use this
